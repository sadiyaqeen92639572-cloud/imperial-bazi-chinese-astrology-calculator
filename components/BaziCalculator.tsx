        ...
        <div className="space-y-10 animate-fade-in" id="bazi-results-section">
            ...
            <>
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-2">
                  ...
                  <h3 className="text-lg font-serif text-slate-100 tracking-wide font-medium">The Four Pillars of Destiny (Sì Zhù)</h3>
                </div>
          ...
          {mode !== 'day-master-only' && result.luckPillars.length > 0 && (
            <div className="space-y-4">
              <div className="flex items-center space-x-2">
                <Compass className="h-5 w-5 text-amber-500" />
                <h3 className="text-lg font-serif text-slate-100 tracking-wide font-medium">10-Year Major Luck Pillars (Da Yun)</h3>
              </div>
