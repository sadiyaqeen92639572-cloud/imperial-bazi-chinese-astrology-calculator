              ...
              <div key={star.code} className="bg-slate-900/60 border border-slate-850 rounded-2xl p-6 space-y-3">
                <div className="flex items-center space-x-2 text-amber-500">
                  ...
                  <h2 className="text-xl font-serif text-slate-100">
                    {star.name} <span className="text-slate-500 text-lg">({star.chinese})</span>
                  </h2>
                </div>
                <p className="text-base text-slate-500">Also known as: {star.altNames.join(', ')}</p>
                <p className="text-lg text-slate-300">{star.summary}</p>
                <p className="text-lg text-slate-400">{star.personality}</p>
                <p className="text-base text-slate-500 pt-2 border-t border-slate-850">{star.howToFind}</p>
              </div>
            );
          })}
        </div>
