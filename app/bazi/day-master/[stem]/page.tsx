    ...
    <>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-12" id={`day-master-${stem}-page`}>
        ...
        <div className="bg-slate-900 border border-slate-850 rounded-2xl p-6 sm:p-8 flex flex-col sm:flex-row items-center justify-between gap-6 shadow-xl relative overflow-hidden">
          ...
          <div className="flex items-center space-x-4 text-center sm:text-left flex-col sm:flex-row">
            ...
            <div>
              <div className="flex items-center justify-center sm:justify-start space-x-2 mt-2 sm:mt-0">
                <span className="text-xs font-semibold px-2.5 py-0.5 bg-amber-500/10 text-amber-500 rounded-full uppercase tracking-wider">
                  {dm.polarity}
                </span>
                <span className="text-slate-500 text-xs italic">({dm.name})</span>
              </div>
          ...
          <p className="text-xs sm:text-sm text-slate-300 sm:max-w-md italic leading-relaxed text-center sm:text-right bg-slate-950 p-4 border border-slate-850 rounded-xl shrink-0">
        ...
        <div className="space-y-8" id="profile-sections">
          ...
          <div className="bg-slate-900/60 border border-slate-850 rounded-xl p-6 sm:p-8 space-y-4">
            ...
            <p className="text-slate-300 text-xs sm:text-sm leading-relaxed">{dm.personality}</p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2">
              ...
              <div className="bg-slate-950 border border-slate-850 p-4 rounded-lg space-y-2">
                <span className="text-xs font-semibold text-amber-400 uppercase tracking-wider">Major Challenges</span>
                <ul className="list-disc list-inside text-xs text-slate-400 space-y-1">
          ...
          <div className="bg-slate-900/60 border border-slate-850 rounded-xl p-6 sm:p-8 space-y-3">
            ...
            <p className="text-slate-300 text-xs sm:text-sm leading-relaxed">{dm.careerPath}</p>
          </div>
          ...
          <div className="bg-slate-900/60 border border-slate-850 rounded-xl p-6 sm:p-8 space-y-3">
            ...
            <p className="text-slate-300 text-xs sm:text-sm leading-relaxed">{dm.loveLife}</p>
          </div>
          ...
          <div className="bg-slate-900/60 border border-slate-850 rounded-xl p-6 sm:p-8 space-y-4">
            ...
            <div className="space-y-3 text-xs sm:text-sm text-slate-300 leading-relaxed">
              <div>
                ...
                <p className="text-slate-400 text-xs mt-1">{dm.bestTenGods}</p>
              </div>
              <div>
                <strong className="text-slate-200">Auspicious Compatibility Alliances:</strong>
                <p className="text-slate-400 text-xs mt-1">{dm.famousDynamics}</p>
              </div>
            </div>
          </div>
