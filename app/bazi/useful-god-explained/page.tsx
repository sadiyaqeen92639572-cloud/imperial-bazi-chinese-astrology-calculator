      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-12" id="useful-god-page">
        ...
        <div className="space-y-8 text-base sm:text-lg text-slate-300 leading-relaxed">
          <div className="space-y-3">
            <h2 className="text-xl font-serif text-slate-100 font-medium tracking-wide flex items-center space-x-2">
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-2">
              <div className="bg-slate-900 border border-slate-850 p-4 rounded-xl space-y-1.5">
                <strong className="text-emerald-400 text-base uppercase tracking-widest">If Day Master is Strong:</strong>
              ...
              <div className="bg-slate-900 border border-slate-850 p-4 rounded-xl space-y-1.5">
                <strong className="text-red-400 text-base uppercase tracking-widest">If Day Master is Weak:</strong>
                <p className="text-base text-slate-400">
